            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  CU : Chandigarh University <br /> Mohali, Punjab <br />
                  PinCode: 140413
                </address>
                <a href="tel:+91 7700818886" className="mt-3 d-block mb-1 text-white">
                  +91 7700818886
                </a>
                <a href="mailto:20bcs9713@cuchd.in" className="mt-2 d-block mb-0 text-white">
                  20bcs9713@cuchd.in
                </a>
                <div className="social-icons d-flex align-items-center gap-15 mt-4">
                  <a className="text-white" href="https://in.linkedin.com/">
