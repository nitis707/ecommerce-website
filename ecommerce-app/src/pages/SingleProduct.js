                        ...
                        <div className="main-product-details">
                            ...
                            <div className="py-3">
                                ...
                                <div className="d-flex gap-10 flex-column mt-2 mb-3">
                                    ...
                                    <div className="d-flex d-wrap gap-15">
                                ...
                                <div className="d-flex align-items-center gap-15 flex-row mt-2 mb-3">
                                    ...
                                    <div className="d-flex alogn-items-center gap-30 ms-5">
                                ...
                                <div className="d-flex gap-10 flex-column my-3">
                                    ...
                                    <p className="product-data">
                                        ...
                                        We ship all Indian domestic orders within 5-10 bussiness days!
                                    </p>
                                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="bg-white p-3">
                            <p>
                                Lorem ipsum dolor. sit amet consectetqr adipisicing elit. Tenetur nisi similique illum aut perferendis voluptas. quisquam obcaecati qui nobis officia. Voluptatibus in harum
